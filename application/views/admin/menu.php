			...
			<div class="container-fluid">
				...
				<div class="btn-group pull-right" >
					...
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li><a href="<?php echo base_url();?>administrator/log_out" >Logout</a></li>
					</ul>
				</div>
				<!-- user dropdown ends -->
				...
				<div class="top-nav nav-collapse">
					<ul class="nav">
						<li><a href="<?php base_url();?>">Visit Site</a></li>
						<li>
			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="<?php echo base_url();?>administrator/gallery"><i class="icon-picture"></i><span class="hidden-tablet"> Gallery</span></a></li>
