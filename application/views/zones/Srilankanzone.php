...
<div class="wrapper row3">
  <div id="container">
    ...
    <div class="clear">
      <!-- ################################################################################################ -->
      <h1> Residential Zone</h1>
      <div class="tab-wrapper clear tab-opt2">
        <div class="one_quarter first">
          <ul class="tab-nav clear">
            <li><a href="#tab-10">Tab 1</a></li>
            <li><a href="#tab-11">Tab 2</a></li>
            <li><a href="#tab-12">Tab 3</a></li>
          </ul>
        </div>
    ...
    <section class="clear">
      <h1> Headline Colour and Size Are All The Same</h1>
