...
class image_CRUD {
	...
	protected $default_language_path = 'admin_assets/image_crud/languages';
	...
	protected function _library_view($view, $vars = array(), $return = FALSE)
	{
		...
		$view_file = 'admin_assets/image_crud/views/';
	...
	{
		include('admin_assets/image_crud/config/translit_chars.php');
